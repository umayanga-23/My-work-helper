...
export const BrandIcon: React.FC<BrandIconProps> = ({ type, platform, className = 'w-4 h-4' }) => {
  const targetType = type || platform || 'WEB_RESOURCE';
  switch (targetType) {
    case 'YOUTUBE':
      return (
    ...
    case 'GOOGLE_DRIVE':
      return <HardDrive className={`${className} text-teal-500`} />;
    default:
